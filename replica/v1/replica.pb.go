...
import (
	v1 "github.com/rotationalio/honu/object/v1"
...
type Sync struct {
	...
	Object *v1.Object  `protobuf:"bytes,2,opt,name=object,proto3" json:"object,omitempty"`                                   // The object being synchronized
...
func (x *Sync) GetObject() *v1.Object {
	if x != nil {
		return x.Object
	}
	return nil
...
var file_replica_v1_replica_proto_goTypes = []any{
	(Sync_Status)(0),  // 0: honu.replica.v1.Sync.Status
	(*Sync)(nil),      // 1: honu.replica.v1.Sync
	(*v1.Object)(nil), // 2: honu.object.v1.Object
}
...
func file_replica_v1_replica_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_replica_v1_replica_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Sync); i {
			case 0:
				return &v.state
			case 1:
