...
func (c *honuClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetReply, error) {
	...
	out := new(GetReply)
	err := c.cc.Invoke(ctx, Honu_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *honuClient) Put(ctx context.Context, in *PutRequest, opts ...grpc.CallOption) (*PutReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PutReply)
	err := c.cc.Invoke(ctx, Honu_Put_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *honuClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*DeleteReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteReply)
	err := c.cc.Invoke(ctx, Honu_Delete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *honuClient) Iter(ctx context.Context, in *IterRequest, opts ...grpc.CallOption) (*IterReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IterReply)
	err := c.cc.Invoke(ctx, Honu_Iter_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *honuClient) Batch(ctx context.Context, opts ...grpc.CallOption) (Honu_BatchClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Honu_ServiceDesc.Streams[0], Honu_Batch_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &honuBatchClient{ClientStream: stream}
	return x, nil
}
...
func (c *honuClient) Cursor(ctx context.Context, in *CursorRequest, opts ...grpc.CallOption) (Honu_CursorClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Honu_ServiceDesc.Streams[1], Honu_Cursor_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &honuCursorClient{ClientStream: stream}
...
func (c *honuClient) Sync(ctx context.Context, opts ...grpc.CallOption) (Honu_SyncClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Honu_ServiceDesc.Streams[2], Honu_Sync_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &honuSyncClient{ClientStream: stream}
	return x, nil
}
...
func (c *honuClient) Count(ctx context.Context, in *CountRequest, opts ...grpc.CallOption) (*CountReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CountReply)
	err := c.cc.Invoke(ctx, Honu_Count_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *honuClient) Status(ctx context.Context, in *HealthCheck, opts ...grpc.CallOption) (*ServerStatus, error) {
	...
	err := c.cc.Invoke(ctx, Honu_Status_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Honu_Batch_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(HonuServer).Batch(&honuBatchServer{ServerStream: stream})
}
...
func _Honu_Cursor_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(HonuServer).Cursor(m, &honuCursorServer{ServerStream: stream})
}
...
func _Honu_Sync_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(HonuServer).Sync(&honuSyncServer{ServerStream: stream})
}
