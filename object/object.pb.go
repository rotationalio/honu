...
type Version struct {
	...
	Created   int64    `protobuf:"varint,6,opt,name=created,proto3" json:"created,omitempty"`     // The timestamp the version was created
}
...
func (x *Version) GetCreated() int64 {
	if x != nil {
		return x.Created
	}
	return 0
...
var file_object_v1_object_proto_rawDesc = []byte{
	...
	0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xb6, 0x01, 0x0a, 0x07, 0x56, 0x65, 0x72,
	...
	0x6d, 0x62, 0x73, 0x74, 0x6f, 0x6e, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x72, 0x65, 0x61, 0x74,
	...
	0x75, 0x2f, 0x6f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
