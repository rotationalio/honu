...
var file_peers_v1_peers_proto_goTypes = []any{
...
func file_peers_v1_peers_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_peers_v1_peers_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Peer); i {
			case 0:
				return &v.state
			case 1:
		...
		file_peers_v1_peers_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_peers_v1_peers_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_peers_v1_peers_proto_msgTypes[3].Exporter = func(v any, i int) any {
